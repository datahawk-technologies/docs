...
export const notionRedirects = [
  ...
  // ── Knowledge hub ────────────────────────────────────────────────────────
  { from: '/Amazon-Advertising-Models-2a04aa5f57fa80d49294cbf78495d839', to: '/help-center/knowledge-hub/dataset-reference/amazon-advertising-data' },
  { from: '/Amazon-Advertising-Models-2a04aa5f57fa80d49294cbf78495d839?source=copy_link', to: '/help-center/knowledge-hub/dataset-reference/amazon-advertising-data' },
  { from: '/search-query-performance-data', to: '/help-center/knowledge-hub/dataset-reference/amz-brand-analytics-data' },
  { from: '/search-query-performance-data?source=copy_link', to: '/help-center/knowledge-hub/dataset-reference/amz-brand-analytics-data' },
  { from: '/Amazon-Vendor-Account-Sourcing-vs-Manufacturing-View-32d4aa5f57fa807ba469c7a59af4a74e', to: '/help-center/knowledge-hub/data-fundamentals/amz-vendor-account-sourcing-manufacturing' },
  { from: '/Amazon-Vendor-Account-Sourcing-vs-Manufacturing-View-32d4aa5f57fa807ba469c7a59af4a74e?source=copy_link', to: '/help-center/knowledge-hub/data-fundamentals/amz-vendor-account-sourcing-manufacturing' },
  { from: '/Amazon-DataHawk-Reports-2f04aa5f57fa80a5b9dfe034202ed249', to: '/help-center/knowledge-hub/dataset-reference/amz-datahawk-reports' },
  { from: '/Amazon-DataHawk-Reports-2f04aa5f57fa80a5b9dfe034202ed249?source=copy_link', to: '/help-center/knowledge-hub/dataset-reference/amz-datahawk-reports' },
  { from: '/inventory-documentation', to: '/help-center/knowledge-hub/dataset-reference/amz-inventory-data' },
  { from: '/inventory-documentation?source=copy_link', to: '/help-center/knowledge-hub/dataset-reference/amz-inventory-data' },
  { from: '/product-pricing-intelligence', to: '/help-center/knowledge-hub/metrics-methodology/amz-product-pricing-offers-intelligence' },
  { from: '/product-pricing-intelligence?source=copy_link', to: '/help-center/knowledge-hub/metrics-methodology/amz-product-pricing-offers-intelligence' },
  { from: '/removal-data', to: '/help-center/knowledge-hub/dataset-reference/amz-removal-data' },
  { from: '/removal-data?source=copy_link', to: '/help-center/knowledge-hub/dataset-reference/amz-removal-data' },
  { from: '/amazon-replenishment-subscribe-save-performance-forecast', to: '/help-center/knowledge-hub/metrics-methodology/subscribe-save-performance-forecast' },
  { from: '/amazon-replenishment-subscribe-save-performance-forecast?source=copy_link', to: '/help-center/knowledge-hub/metrics-methodology/subscribe-save-performance-forecast' },
  { from: '/amazon-returns-data', to: '/help-center/knowledge-hub/dataset-reference/amz-returns-data' },
  { from: '/amazon-returns-data?source=copy_link', to: '/help-center/knowledge-hub/dataset-reference/amz-returns-data' },
  { from: '/amazon-sales-estimates', to: '/help-center/knowledge-hub/metrics-methodology/amz-sales-estimates' },
  { from: '/amazon-sales-estimates?source=copy_link', to: '/help-center/knowledge-hub/metrics-methodology/amz-sales-estimates' },
  { from: '/seller-profit-data', to: '/help-center/knowledge-hub/dataset-reference/amz-seller-profit-data' },
  { from: '/seller-profit-data?source=copy_link', to: '/help-center/knowledge-hub/dataset-reference/amz-seller-profit-data' },
  { from: '/Amazon-Seller-Profit-Reading-Your-Reports-33b4aa5f57fa8030ac92e201a546e618', to: '/help-center/knowledge-hub/data-fundamentals/amz-seller-profit-read-reports' },
  { from: '/Amazon-Seller-Profit-Reading-Your-Reports-33b4aa5f57fa8030ac92e201a546e618?source=copy_link', to: '/help-center/knowledge-hub/data-fundamentals/amz-seller-profit-read-reports' },
  { from: '/automated-competitors-detection', to: '/help-center/knowledge-hub/metrics-methodology/auto-competitors-detection' },
  { from: '/automated-competitors-detection?source=copy_link', to: '/help-center/knowledge-hub/metrics-methodology/auto-competitors-detection' },
  { from: '/recipes-convert-currencies', to: '/help-center/knowledge-hub/dataset-reference/convert-currencies' },
  { from: '/recipes-convert-currencies?source=copy_link', to: '/help-center/knowledge-hub/dataset-reference/convert-currencies' },
  { from: '/daily-exchange-rate-dataset', to: '/help-center/knowledge-hub/dataset-reference/daily-exchange-rate-dataset' },
  { from: '/daily-exchange-rate-dataset?source=copy_link', to: '/help-center/knowledge-hub/dataset-reference/daily-exchange-rate-dataset' },
  { from: '/datasets-models', to: '/help-center/knowledge-hub/dataset-reference/find-tables-and-columns' },
  { from: '/datasets-models?source=copy_link', to: '/help-center/knowledge-hub/dataset-reference/find-tables-and-columns' },
  { from: '/How-DataHawk-Sources-Your-Data-33e4aa5f57fa81b1a8beffff7a716b69', to: '/help-center/knowledge-hub/data-fundamentals/how-datahawk-sources-data' },
  { from: '/How-DataHawk-Sources-Your-Data-33e4aa5f57fa81b1a8beffff7a716b69?source=copy_link', to: '/help-center/knowledge-hub/data-fundamentals/how-datahawk-sources-data' },
  { from: '/Key-Concepts-33e4aa5f57fa8197841bd9c7c1548921', to: '/help-center/knowledge-hub/data-fundamentals/key-concepts' },
  { from: '/Key-Concepts-33e4aa5f57fa8197841bd9c7c1548921?source=copy_link', to: '/help-center/knowledge-hub/data-fundamentals/key-concepts' },
  { from: '/keyword-research', to: '/help-center/knowledge-hub/metrics-methodology/keyword-research' },
  { from: '/keyword-research?source=copy_link', to: '/help-center/knowledge-hub/metrics-methodology/keyword-research' },
  { from: '/keyword-search-volume', to: '/help-center/knowledge-hub/metrics-methodology/keyword-search-volume' },
  { from: '/keyword-search-volume?source=copy_link', to: '/help-center/knowledge-hub/metrics-methodology/keyword-search-volume' },
  { from: '/listing-quality-analysis', to: '/help-center/knowledge-hub/metrics-methodology/listing-quality-analysis' },
  { from: '/listing-quality-analysis?source=copy_link', to: '/help-center/knowledge-hub/metrics-methodology/listing-quality-analysis' },

  // ── Looker Studio ────────────────────────────────────────────────────────
  { from: '/looker-studio-template', to: '/help-center/dashboard-templates/looker-studio' },
  { from: '/looker-studio-template?source=copy_link', to: '/help-center/dashboard-templates/looker-studio' },
  { from: '/client-level-looker-studio-dashboards', to: '/help-center/dashboard-templates/looker-studio/white-label' },
  { from: '/client-level-looker-studio-dashboards?source=copy_link', to: '/help-center/dashboard-templates/looker-studio/white-label' },
  ...
  { from: '/ads-dsp-dashboard-documentation?source=copy_link', to: '/help-center/dashboard-templates/power-bi/ads-dsp-dashboard' },
  { from: '/advertising-dashboard-user-guide', to: '/help-center/dashboard-templates/power-bi/advertising-dashboard' },
  { from: '/advertising-dashboard-user-guide?source=copy_link', to: '/help-center/dashboard-templates/power-bi/advertising-dashboard' },
  { from: '/market-intelligence-dashboard-user-guide', to: '/help-center/dashboard-templates/power-bi/market-intelligence-dashboard' },
  { from: '/market-intelligence-dashboard-user-guide?source=copy_link', to: '/help-center/dashboard-templates/power-bi/market-intelligence-dashboard' },
  { from: '/product-dashboard-user-guide', to: '/help-center/dashboard-templates/power-bi/product-dashboard' },
  { from: '/product-dashboard-user-guide?source=copy_link', to: '/help-center/dashboard-templates/power-bi/product-dashboard' },
  { from: '/seller-analytics-dashboard-user-guide', to: '/help-center/dashboard-templates/power-bi/seller-analytics-dashboard' },
  { from: '/seller-analytics-dashboard-user-guide?source=copy_link', to: '/help-center/dashboard-templates/power-bi/seller-analytics-dashboard' },
  { from: '/master-vendor-dashboard-user-guide', to: '/help-center/dashboard-templates/power-bi/vendor-analytics-dashboard' },
  { from: '/master-vendor-dashboard-user-guide?source=copy_link', to: '/help-center/dashboard-templates/power-bi/vendor-analytics-dashboard' },
