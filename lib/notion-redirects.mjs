...
export const notionRedirects = [
  ...
  { from: '/Amazon-Vendor-Account-Sourcing-vs-Manufacturing-View-32d4aa5f57fa807ba469c7a59af4a74e', to: '/help-center/data-metrics-guides/amz-vendor-account-sourcing-manufacturing' },
  ...
  { from: '/product-pricing-intelligence', to: '/help-center/data-metrics-guides/amz-product-pricing-offers-intelligence' },
  { from: '/removal-data', to: '/help-center/data-reference/amz-removal-data' },
  { from: '/amazon-replenishment-subscribe-save-performance-forecast', to: '/help-center/data-metrics-guides/subscribe-save-performance-forecast' },
  { from: '/amazon-returns-data', to: '/help-center/data-reference/amz-returns-data' },
  { from: '/amazon-sales-estimates', to: '/help-center/data-metrics-guides/amz-sales-estimates' },
  { from: '/seller-profit-data', to: '/help-center/data-reference/amz-seller-profit-data' },
  { from: '/Amazon-Seller-Profit-Reading-Your-Reports-33b4aa5f57fa8030ac92e201a546e618', to: '/help-center/data-metrics-guides/amz-seller-profit-read-reports' },
  { from: '/automated-competitors-detection', to: '/help-center/data-metrics-guides/auto-competitors-detection' },
  ...
  { from: '/How-DataHawk-Sources-Your-Data-33e4aa5f57fa81b1a8beffff7a716b69', to: '/help-center/data-metrics-guides/how-datahawk-sources-data' },
  { from: '/Key-Concepts-33e4aa5f57fa8197841bd9c7c1548921', to: '/help-center/data-metrics-guides/key-concepts' },
  { from: '/keyword-research', to: '/help-center/data-metrics-guides/keyword-research' },
  { from: '/keyword-search-volume', to: '/help-center/data-metrics-guides/keyword-search-volume' },
  { from: '/listing-quality-analysis', to: '/help-center/data-metrics-guides/listing-quality-analysis' },
