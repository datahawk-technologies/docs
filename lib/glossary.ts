...
export const glossary: Record<string, GlossaryEntry> = {
  ...
  ASIN: {
    ...
    readMore: '/help-center/data-metrics-guides/foundation/key-concepts#asin--what-it-is-and-why-it-matters',
  },
  'PARENT ASIN': {
    title: 'Parent ASIN',
    ...
    readMore: '/help-center/data-metrics-guides/foundation/key-concepts#parent-asins-and-child-asins--understanding-product-variants',
  },
  'CHILD ASIN': {
    title: 'Child ASIN',
  ...
  SKU: {
    ...
    readMore: '/help-center/data-metrics-guides/foundation/key-concepts#sku--your-internal-product-reference',
  },
  FNSKU: {
  ...
  MARKETPLACE: {
    ...
    readMore: '/help-center/data-metrics-guides/foundation/key-concepts#marketplace-vs-channel',
  },
  ...
  BSR: {
    ...
    readMore: '/help-center/data-metrics-guides/foundation/key-concepts#bsr--best-seller-rank',
  },
  SQP: {
  ...
  'SALES ESTIMATES': {
    ...
    readMore: '/help-center/data-metrics-guides/competition/amz-sales-estimates',
  },
  LQS: {
    ...
    readMore: '/help-center/data-metrics-guides/content/listing-quality-analysis',
  },
  ...
  SOURCING: {
    ...
    readMore: '/help-center/data-metrics-guides/foundation/key-concepts#amazon-vendor-views-sourcing-vs-manufacturing',
  },
  MANUFACTURING: {
