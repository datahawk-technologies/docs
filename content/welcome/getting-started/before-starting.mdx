...
This 24-hour wait is separate from how far back your historical data goes once it appears; that depends on the channel. See [Data history and refresh by channel](/help-center/data-reference/source-systems-freshness#data-history-and-refresh-by-channel) for the specifics on Seller, Vendor, and Advertising.
