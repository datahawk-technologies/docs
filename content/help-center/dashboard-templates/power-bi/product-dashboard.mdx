...
**Data history:** Up to 90 days by default. Need more? See [Changing the historical lookback window](/help-center/connect-tools/powerbi#changing-the-historical-lookback-window).
...
<div className="card-grid">
  <Card
    title="Download the Product template"
    href="https://github.com/datahawk-technologies/docs/releases/download/power-bi-templates/product-dashboard.pbix"
    description="Download the latest Power BI template for the Product dashboard."
  />
    <Card
