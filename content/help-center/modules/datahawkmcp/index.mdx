...
<Callout type="info">
  **Building something heavier?** For large-scale work, pulling years of data, joining DataHawk with your own systems, building custom analytics pipelines, your Snowflake or BigQuery data warehouse export is a better fit than MCP (DataHawk's API configures the workspace and isn't a data-retrieval channel). Email [support@datahawk.co](mailto:support@datahawk.co) and we'll point you in the right direction.
</Callout>
...
**How fresh is the data?** DataHawk refreshes once a day, at **9 AM PST**. See [How DataHawk Sources Your Data](/help-center/data-metrics-guides/foundation/how-datahawk-sources-data) for the full source-by-source freshness table.
