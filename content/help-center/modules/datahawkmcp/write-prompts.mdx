...
Your AI assistant is only as good as the question you give it. This guide shows you how to phrase prompts so DataHawk <Term>MCP</Term> returns the right answer the first time.
...
2. **The dimension** — how to break it down (by <Term>ASIN</Term>, by campaign, by keyword, by marketplace, by day…)
...
| Catalog | price, rating, review count, buy box, A+ content, variation, browse node |
