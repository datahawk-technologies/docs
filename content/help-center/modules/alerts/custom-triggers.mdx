...
1. Open **Apps → Alerts** and click **Create alert**
2. Choose **Create custom trigger**
3. Pick a **property** (e.g. Buy Box price, <Term>BSR</Term>, number of ratings)
4. Pick an **operator** (e.g. *decreases by more than X%*)
5. Set a **value** appropriate for the operator
6. Click **Continue**, then choose the product (or tag) and the recipient group
7. Save
