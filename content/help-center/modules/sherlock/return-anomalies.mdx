...
**Return Anomalies** surfaces products whose return rate has spiked. A small rise in returns can quietly erase profit, so catching it early matters. Sherlock compares the last 30 days against a 90-day baseline and flags anything that looks off.
