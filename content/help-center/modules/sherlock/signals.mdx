...
The **Signals** page is your daily starting point. It shows every product whose sales moved in a meaningful way week-over-week, ranked by dollar impact, so you know what to look at first.
...
- **Cases** → *Zombie Ad Spend*, *Return Anomalies*, *Ad Spend Drop*, *Price CVR Drop*, *FBA Stockout*, *Buy Box Loss*. Each Case is a curated shortcut for a specific risk pattern.
...
|---|---|
| **Product** | Product title, marketplace flag, parent and child ASIN (each with a copy icon) |
