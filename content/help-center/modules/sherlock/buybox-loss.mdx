...
**Buy Box Loss** flags listings where you raised the price and the Buy Box dropped along with it. In most cases, the price hike pushed Amazon's algorithm to favour another seller (or no one), and you stopped winning the "Buy now" button.
