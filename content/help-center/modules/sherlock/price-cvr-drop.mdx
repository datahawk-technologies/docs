...
Price CVR Drop is one of <Term>Sherlock</Term>'s investigation cases. It looks for products where a price increase coincided with a fall in conversion rate — the listings where the new price scared shoppers off rather than just losing the <Term>Buy Box</Term>. Use this page to weigh the revenue you'd recover by reverting the price.
