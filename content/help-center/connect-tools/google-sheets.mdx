...
For larger datasets, consider using [BigQuery](/help-center/connect-tools/bigquery) directly with Looker Studio, or [Snowflake](/help-center/connect-tools/snowflake) with Power BI.
