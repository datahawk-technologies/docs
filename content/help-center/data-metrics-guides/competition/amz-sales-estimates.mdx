...
description: How DataHawk estimates daily sales for tracked products and competitors; variant-level estimates by default, model methodology and table reference.
---
...
<div className="card-grid">
  <Card
    ...
    description="Tables, deprecated aliases, key columns, granularity, refresh behavior, and FAQ."
  />
</div>
