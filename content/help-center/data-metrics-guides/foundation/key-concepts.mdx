...
<Callout type="info">
  **Amazon Sales Estimates note:** DataHawk now provides sales estimates at the child (variant) level by default. See [Amazon Sales Estimates](/help-center/data-metrics-guides/competition/amz-sales-estimates) for details.
</Callout>
...
If you see data in one view but not the other, it usually reflects Amazon's permissions and reporting model, not a DataHawk collection issue. For troubleshooting steps, see [I cannot see data in manufacturing views, but I see it in sourcing](/troubleshooting/data-discrepancies/manufacturing-vs-sourcing-views).
