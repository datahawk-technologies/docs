---
title: Use Tags
description: Tag Products and Keywords to organize your catalog and target dashboards, Alerts, Insights, and Sherlock at any slice.
---
...
- **Scope Alerts and Insights** to a group — get pinged only when *your premium SKUs* lose Buy Box, instead of for every product.
...
- **Insights** — surface anomalies for a tagged group only.
