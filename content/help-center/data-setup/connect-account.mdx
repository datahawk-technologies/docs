...
## How to connect Walmart Connect Account
...
Add your advertising ID. [Locate your advertising ID](https://advertisinghelp.walmart.com/s/guides?language=en_US&article=000009632)
<img
  src="/images/help-center/data-setup/connect-account/connect-account-2.png"
  alt="connect-account 2"
  width={600}
  height={340}
  className="rounded-lg border"
/>
...
Select your sellet type: 1P or 3P
Here is [Walmart user roles and permissions guide](https://advertisinghelp.walmart.com/s/guides?language=en_US&article=000009334)

<img
  src="/images/help-center/data-setup/connect-account/connect-account-3.png"
  alt="connect-account 3"
  width={600}
  height={340}
  className="rounded-lg border"
/>
