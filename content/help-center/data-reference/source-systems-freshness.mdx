...
Use this page when you need to map a business data type to its source API, account requirement, schema, or freshness field. For a business-friendly explanation of public vs. private data, see [How DataHawk Sources Your Data](/help-center/data-metrics-guides/foundation/how-datahawk-sources-data).
...
For the full schema map, see [Technical Reference](/help-center/data-reference).

## Data history and refresh by channel

<Callout type="info">
  Two different questions get confused often: **"how far back does my history go"** (how much data DataHawk retrieves when you first connect) and **"how long until I see any data"** (the processing time before that historical data appears at all, roughly 24 hours for any source — see [Before Starting](/welcome/getting-started/before-starting)). The table below answers the first question.
</Callout>

| Channel | Historical backfill on connection | Refresh frequency | Typical delay on recent data |
|---|---|---|---|
| **Seller** | Up to 2 years | Daily | Latest 48 hours may be incomplete. See [Seller account setup](/help-center/data-setup/seller-account). |
| **Vendor** | Up to 3 years | Daily | About 72 hours (roughly 3 days), due to Amazon API limitations. Demand Forecasts specifically refresh weekly, not daily. See [Vendor account setup](/help-center/data-setup/vendor-account). |
| **Advertising** | Up to 60 days (the maximum Amazon's Ads API allows) | Daily | Latest 24–48 hours may still be incomplete while Amazon finishes processing. See [Advertising account setup](/help-center/data-setup/ads-account). |
