...
Use this page when you need to map a business data type to its source API, account requirement, schema, or freshness field. For a business-friendly explanation of public vs. private data, see [How DataHawk Sources Your Data](/help-center/data-metrics-guides/how-datahawk-sources-data).
