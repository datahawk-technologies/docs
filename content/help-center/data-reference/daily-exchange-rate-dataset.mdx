...
This table is joined on **date and currency** to convert local values into USD. See the [Convert Currencies](/help-center/data-reference/convert-currencies) page for a full worked SQL example.
