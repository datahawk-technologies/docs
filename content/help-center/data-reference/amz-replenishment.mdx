...
<Callout type="info">
  For business usage, metric interpretation, and inventory-planning examples, see [Subscribe & Save Forecasting](/help-center/data-metrics-guides/inventory/subscribe-save-performance-forecast).
</Callout>
