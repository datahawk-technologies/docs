...
<Callout type="info">
  For business context, return dispositions, and how to interpret return patterns, see [Understanding Amazon Returns](/help-center/data-metrics-guides/understanding-amazon-returns).
</Callout>
