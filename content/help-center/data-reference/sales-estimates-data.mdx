...
<Accordions>
  ...
  <Accordion title="My child estimates don't add up to the parent. Why?">
    This can happen when the family definition changes over time, or when only some variants in a family are tracked. Use `VARIATION_COUNT` to understand the full known family size used at estimation time.
  </Accordion>
