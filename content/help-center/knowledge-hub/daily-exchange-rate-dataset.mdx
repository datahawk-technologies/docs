...
This table is joined on **date and currency** to convert local values into USD. See the [Convert Currencies](/help-center/knowledge-hub/convert-currencies) page for a full worked SQL example.
