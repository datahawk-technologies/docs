...
This is the most common source of "why are my numbers different?" tickets. See [I can't see data in Manufacturing views, but I see it in Sourcing](/troubleshooting/data-discrepancies/i-cannot-see-data-in-manufacturing-views,-but-i-see-it-in-sourcing).
...
The amount you paid to manufacture or buy the products you sold. Uploaded into DataHawk via CSV to enable accurate profit calculations. See [Upload COGS](https://docs.datahawk.co/upload-amazon-product-expenses).
