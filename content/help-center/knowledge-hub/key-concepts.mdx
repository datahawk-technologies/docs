...
- A **channel** (sometimes called a selling channel or fulfilment channel) refers to how products are fulfilled: FBA (Fulfilled by Amazon) vs FBM/MFN (Fulfilled by Merchant).
...
| `SKU` | Seller-defined identifier | Private data tables (orders, inventory, COGS) |
