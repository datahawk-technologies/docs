...
|---|---|---|---|
| `RETURNS_DATA_SRC` | FBM (Fulfilled by Merchant) orders only | June 2023 | Return records keyed by return date. Includes <Term>ASIN</Term>, <Term>SKU</Term>, return quantities, reason codes, and metadata. |
