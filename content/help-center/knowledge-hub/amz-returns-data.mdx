...
| **Damaged** | Damaged by carrier or fulfillment centre — Amazon reimburses you |
...
| `FBA_CUSTOMER_RETURNS_SRC` | FBA (Fulfilled by Amazon) orders | — | Detailed FBA return records including Fulfillment Centre ID, disposition, customer comments, and reason codes. |
...
| Damaged by fulfillment centre | CR-DAMAGED_BY_FC | DAMAGED_BY_FC |
