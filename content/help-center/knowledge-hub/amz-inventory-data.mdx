...
<Callout type="info">
  **View Your Inventory at the Country Level**
  ...
  - **FBA → `SELLER_INVENTORY_FBA_PLANNING`** — FBA qty with AI-driven recommendations for aged stock and removals
  - **FBM → `SELLER_INVENTORY_ALL_LISTINGS`** — your catalog with pricing and availability for MFN
