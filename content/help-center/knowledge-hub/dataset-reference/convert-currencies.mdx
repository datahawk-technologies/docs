...
See [Daily Exchange Rate Dataset](/help-center/knowledge-hub/dataset-reference/daily-exchange-rate-dataset) for details on the underlying exchange rate table.

The snippet below performs the conversion of financial data on a dataset without a currency field by joining to the <Term>marketplace</Term> referential table that contains the currency field.
