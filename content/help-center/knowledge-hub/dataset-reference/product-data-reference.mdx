...
Use this page when you need to query product-level DataHawk data or join product tables together. For conceptual explanations, start with [Key Concepts](/help-center/knowledge-hub/data-fundamentals/key-concepts).
