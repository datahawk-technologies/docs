...
If you are not sure where to start, use [Source Systems & Freshness](/help-center/knowledge-hub/dataset-reference/source-systems-freshness) to map data types to source systems and schemas.
...
For source-system delays and freshness guidance, see [Source Systems & Freshness](/help-center/knowledge-hub/dataset-reference/source-systems-freshness).
...
4. Confirm field meaning in [Product Data Reference](/help-center/knowledge-hub/dataset-reference/product-data-reference#pricing-and-offers-tables).
...
3. Confirm current V7 tables and deprecated aliases in [Sales Estimates Data](/help-center/knowledge-hub/dataset-reference/sales-estimates-data).
...
4. For Walmart-specific tables, use [Walmart Advertising Data](/help-center/knowledge-hub/dataset-reference/wmt-advertising-data).
...
4. For a SQL example, see [Convert Currencies](/help-center/knowledge-hub/dataset-reference/convert-currencies).
