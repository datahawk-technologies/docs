...
const config = {
  ...
  async redirects() {
    const internalRedirects = [
      ...
      { source: '/troubleshooting/i-don%27t-see-data-after-connecting-my-dsp-account', destination: '/troubleshooting/connection-failures/no-data-after-dsp-connect', permanent: true },
      { source: '/troubleshooting/connection-failures/i-don%27t-see-data-after-connecting-my-dsp-account', destination: '/troubleshooting/connection-failures/no-data-after-dsp-connect', permanent: true },
      { source: '/troubleshooting/i-don%27t-see-traffic-data-for-my-asin', destination: '/troubleshooting/data-not-refreshing/no-traffic-data-for-asin', permanent: true },
      { source: '/troubleshooting/data-not-refreshing/i-don%27t-see-traffic-data-for-my-asin', destination: '/troubleshooting/data-not-refreshing/no-traffic-data-for-asin', permanent: true },
      ...
      { source: '/help-center/knowledge-hub/amz-replenishment', destination: '/help-center/data-metrics-guides/inventory/subscribe-save-performance-forecast', permanent: true },
      ...
      { source: '/help-center/knowledge-hub/keyword-search-volume', destination: '/help-center/data-metrics-guides/search/keyword-research', permanent: true },
      { source: '/help-center/knowledge-hub/:path*', destination: '/help-center/data-metrics-guides/:path*', permanent: true },
      { source: '/help-center/data-metrics-guides/how-datahawk-sources-data', destination: '/help-center/data-metrics-guides/foundation/how-datahawk-sources-data', permanent: true },
      { source: '/help-center/data-metrics-guides/key-concepts', destination: '/help-center/data-metrics-guides/foundation/key-concepts', permanent: true },
      { source: '/help-center/data-metrics-guides/keyword-research', destination: '/help-center/data-metrics-guides/search/keyword-research', permanent: true },
      { source: '/help-center/data-metrics-guides/brand-analytics-sqp', destination: '/help-center/data-metrics-guides/search/brand-analytics-sqp', permanent: true },
      { source: '/help-center/data-metrics-guides/listing-quality-analysis', destination: '/help-center/data-metrics-guides/content/listing-quality-analysis', permanent: true },
      { source: '/help-center/data-metrics-guides/amz-product-pricing-offers-intelligence', destination: '/help-center/data-metrics-guides/content/amz-product-pricing-offers-intelligence', permanent: true },
      { source: '/help-center/data-metrics-guides/amz-sales-estimates', destination: '/help-center/data-metrics-guides/competition/amz-sales-estimates', permanent: true },
      { source: '/help-center/data-metrics-guides/auto-competitors-detection', destination: '/help-center/data-metrics-guides/competition/auto-competitors-detection', permanent: true },
      { source: '/help-center/data-metrics-guides/advertising-performance', destination: '/help-center/data-metrics-guides/advertising/advertising-performance', permanent: true },
      { source: '/help-center/data-metrics-guides/walmart-advertising', destination: '/help-center/data-metrics-guides/advertising/walmart-advertising', permanent: true },
      { source: '/help-center/data-metrics-guides/profitability-analysis', destination: '/help-center/data-metrics-guides/finance/profitability-analysis', permanent: true },
      { source: '/help-center/data-metrics-guides/understanding-amazon-returns', destination: '/help-center/data-metrics-guides/finance/understanding-amazon-returns', permanent: true },
      { source: '/help-center/data-metrics-guides/inventory-and-replenishment', destination: '/help-center/data-metrics-guides/inventory/inventory-and-replenishment', permanent: true },
      { source: '/help-center/data-metrics-guides/subscribe-save-performance-forecast', destination: '/help-center/data-metrics-guides/inventory/subscribe-save-performance-forecast', permanent: true },
      { source: '/help-center/data-metrics-guides/profit-and-loss', destination: '/help-center/data-metrics-guides/finance/profitability-analysis', permanent: true },
      { source: '/help-center/data-metrics-guides/amz-seller-profit-read-reports', destination: '/help-center/data-metrics-guides/finance/profitability-analysis', permanent: true },
      { source: '/help-center/data-metrics-guides/amz-vendor-account-sourcing-manufacturing', destination: '/help-center/data-metrics-guides/foundation/key-concepts#amazon-vendor-views-sourcing-vs-manufacturing', permanent: true },
