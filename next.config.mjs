...
const config = {
  ...
  async redirects() {
    const internalRedirects = [
      ...
      { source: '/help-center/data-metrics-guides/profit-and-loss', destination: '/help-center/data-metrics-guides/profitability-analysis', permanent: true },
      { source: '/help-center/data-metrics-guides/amz-seller-profit-read-reports', destination: '/help-center/data-metrics-guides/profitability-analysis', permanent: true },
